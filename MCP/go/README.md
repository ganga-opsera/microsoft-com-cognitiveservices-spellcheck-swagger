# Spell Check Client MCP Server

This MCP (Model Content Protocol) server provides access to Spell Check Client API functionality through HTTP, HTTPS, and STDIO transport modes.
