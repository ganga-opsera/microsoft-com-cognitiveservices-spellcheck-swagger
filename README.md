# microsoft.com API - Version cognitiveservices-SpellCheck
...
- **Version**: cognitiveservices-SpellCheck
- **File**: swagger.yaml
- **Original Path**: microsoft.com/cognitiveservices-SpellCheck/1.0/swagger.yaml
